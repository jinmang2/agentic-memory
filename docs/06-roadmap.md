...
> **상태 안내 (2026-09-08)**: 아래 Phase·체크박스는 v0 개발 당시 계획과 경과 기록이다. 열린 항목을 현재 진행 중 작업으로 해석하지 않는다.
> v0 연구는 2026-09-02 종료했다([결론과 미측정 범위](22-v0-summary.md)). v1의 새 세션 도그푸딩은 2026-09-06 완료했다
> ([현재 구현·측정 상태](23-v1-experience-memory.md)). 지금 이어갈 구현·측정·연구 후보는 [후속 조사](24-next-research-and-implementation.md)가 기준이다.
> 아래 소형 모델 학습·방법론 확장은 후속 실행이 확인된 항목이 아니며, 이번 갱신에서 재개하지 않았다.
